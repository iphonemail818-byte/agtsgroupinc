// AGTS Group Inc - Luxury SUV Transportation Pricing Engine
// COMPETITIVE PRICING - Comparable to Uber Black/Lyft Lux
...
const PRICING_CONFIG = {
    ...
    perMileRate: 3.50,        // Competitive per mile rate (Uber Black: $3.50-4.00)
    perMinuteRate: 0.55,      // Competitive per minute rate (Uber Black: $0.55-0.65)
    ...
    maximumPricePerMile: 8.00, // Never charge more than $8 per mile
...
function calculateFare(tripDetails) {
    ...
    if (pricePerMile > PRICING_CONFIG.maximumPricePerMile) {
        subtotal = PRICING_CONFIG.maximumPricePerMile * (details.distance || 1);
    }
...
/**
 * Get price range for common trip distances
 * Useful for displaying estimated prices
 */
function getPriceRanges() {
    return {
        short: { distance: 5, price: getCompetitiveEstimate(5) },
        medium: { distance: 10, price: getCompetitiveEstimate(10) },
        long: { distance: 20, price: getCompetitiveEstimate(20) }
    };
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        PRICING_CONFIG,
        calculateFare,
        getCompetitiveEstimate,
        getPriceRanges,
        compareWithUberBlack
    };
}
